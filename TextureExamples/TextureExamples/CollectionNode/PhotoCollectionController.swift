...
class PhotoCollectionController: ASDKViewController<ASCollectionNode> {
...
extension PhotoCollectionController: ASCollectionDataSource {
    ...
    func collectionNode(_ collectionNode: ASCollectionNode, nodeBlockForItemAt indexPath: IndexPath) -> ASCellNodeBlock {
        let cellNodeBlock: ASCellNodeBlock = {
            let cell = PhotoCollectionNodeCell(indexPath.row)
...
extension PhotoCollectionController: ASCollectionDelegate {
